...
urlpatterns = [
    ...
    url(r'^Manage/user/(?P<user_alias>[a-zA-Z0-9\-_.]+)/$', views.manage_report, name='et_manage_report_user'),
    url(r'^Manage/user/(?P<user_alias>[a-zA-Z0-9\-_.]+)/delete/$', views.manage_delete_user, name='et_manage_delete_user'),
    url(r'^Manage/step/(?P<order_id>[0-9]{1,4})/$', views.manage_report, name='et_manage_report_step'),
